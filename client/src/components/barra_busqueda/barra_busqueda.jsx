...
class BarraBusqueda extends Component {
  ...
  render() {
    return (
        <div className = "row">
              <div className="input-group-text col-1" id="basic-addon1">
              ...
              <input type="email" className="form-control col-11" placeholder={this.props.placeholder} onChange={this.props.onSearch}/>
        </div>
    );
  }
}
